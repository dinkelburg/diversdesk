...
slug: features-resources/direct-bookings
sidebar:
...
<div style="text-align: center; margin: 20px 0;">
  <img src="/images/book_now.png" alt="Direct booking or self-booking option" style="max-width: 50%;" />
</div>
...
<VideoLightbox
  src="/images/copy_url_to_my_page.gif"
  label="Copy the URL to My Page"
...
<VideoLightbox
  src="/images/copy_url_to_activity.gif"
  label="Copy the URL to a specific activity"
  previewDesktopWidth="80%"
/>
...
<VideoLightbox
  src="/images/copy_url_to_book_now_button.gif"
  label="Copy the URL from the Book Now button"
  previewDesktopWidth="80%"
/>
...
You can now embed your Diversdesk webshop or a specific booking page directly into your own website with an iframe. Read the setup guide here: [Website Iframe Integration](/features-resources/website-iframe-integration).
:::
