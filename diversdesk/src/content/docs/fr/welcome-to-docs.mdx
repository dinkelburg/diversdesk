...
hero:
  ...
  image:
      alt: A Diversdesk's Logo
      dark: ../../../images/starlight/diversdesk_hero.svg
      light: ../../../images/starlight/diversdesk_hero_dark.svg
  actions:
    - text: Get started
      icon: right-arrow
      variant: primary
    ...
    - text: View on GitHub
      icon: external
      link: https://github.com/mearashadowfax/Diversdesk
---
...
<CardGrid stagger>
  ...
  <Card title="Outils et Équipements" icon="seti:eslint">
    Découvrez la gamme complète d'outils et d'équipements de qualité supérieure de Diversdesk. Chaque sous-section offre des spécifications détaillées, des instructions d'utilisation et des conseils de maintenance.
  </Card>
