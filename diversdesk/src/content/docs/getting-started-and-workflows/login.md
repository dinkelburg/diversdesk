...
<div
  class="login-intro-image-wrap"
  style="--login-image-width: 100%; --login-image-width-md: 70%; --login-image-width-lg: 60%;"
>
  <img
...
Signing up can be done through the sign-up button on [app.diversdesk.com](https://app.diversdesk.com/u?toggle_modal=account&persist_flow=signin) or, for Diversdesk white-label users, via the personal URL that we've provided to you.
...
<div class="bullet-numbered-bold">
