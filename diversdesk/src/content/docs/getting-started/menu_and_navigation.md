...
A simple date picker allows you to quickly move between days.

An underscore below a date shows that an activity is scheduled on that day.
...
![Month calendar](/images/Month_calendar.png)
