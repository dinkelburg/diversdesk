...
<table style="width:100%; border-collapse: collapse;">
    <thead>
        <tr>
            <th style="padding: 8px; background-color: #f4f4f4;">Category</th>
            <th style="padding: 8px; background-color: #f4f4f4;">Description</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="padding: 8px;">Must</td>
            <td style="padding: 8px;">Boat roster with all rental gear sizes to 2-3 boats.
                <div class="bullet-checkmark">
                    <ul>
                        <li>Height</li>
                        <li>Weight</li>
                        <li>Shoe Size</li>
        ...
        <tr>
            <td style="padding: 8px;">Must</td>
            <td style="padding: 8px;">Taxi orders to all boats in different locations (all details ready to template to taxi company)
                <div class="bullet-checkmark">
                    <ul>
                        <li>First & Last name</li>
                        <li>Booking Referencet</li>
                        <li>Hotel + Address</li>
                        <li>Room number</li>
                    </ul>
                </div>
        ...
        <tr>
            <td style="padding: 8px;">Must</td>
            <td style="padding: 8px;">Customer details to insurance (template with all customer details for insurance company via mail)
                <div class="bullet-checkmark">
                    <ul>
                        <li>Input field: Provider & Policy Number</li>
                    </ul>
                </div>
        ...
        <tr>
            <td style="padding: 8px;">Must</td>
            <td style="padding: 8px;">
                Ability to replace all sections of our current <a href="https://fastmanta.com/booking-form/"target="_blank">registration form</a> containing at least the following info:
                <div class="bullet-checkmark">
                <ul>
                ...
                <br><a href="https://doc.clickup.com/2633992/d/h/2gc88-3955/fcf0a46a215e4ab/" target="_blank">Document</a> with each onboarding journey we've setup.
            </td>
        </tr>
        <tr>
            <td style="padding: 8px;">Must</td>
            <td style="padding: 8px;">
                <div class="bullet-crossmark">
                    <ul>
                     <li>Food orders to all boats (all details ready to restaurant)</li>
                    </ul>
                </div>
            </td>
        </tr>
        <tr>
            <td style="padding: 8px;">Should</td>
            <td style="padding: 8px;">
        ...
        <tr>
            ...
            <td style="padding: 8px;">
                <div class="bullet-crossmark">
                    <ul>
                        <li>Email with details (welcome mail) time triggered
                        <br>Remember to fill x en x
                        <br>Remmember to bring this.</li>
                    </ul>
                </div>
            </td>
        </tr>
