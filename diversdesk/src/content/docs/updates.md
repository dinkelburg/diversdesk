---
title: The Diversdesk UX Overhaul
description: A brand-new webshop, streamlined checkout, and massive UX improvements.
lastUpdated: 2026-02-24
---

<!-- # v2.0.0 <Badge text="Latest" variant="success" /> -->

Release Date: February 25, 2026

# A Fresh New Look! <Badge text="Major Update" variant="note" size="large" />

We’ve performed a major UX overhaul to make your daily operations faster and more intuitive than ever. From a renewed webshop to a seamless guest checkout.
...
<div class="video-container">
  <iframe 
    ...
    title="Diversdesk v2.4.0 Update" 
    frameborder="0" 
...
<!-- ![New Webshop Interface](../../assets/updates/v240-webshop-preview.webp)
*The brand new guest-facing webshop showing featured products and categories.* -->

* **Unified Experience:** Advertise **Retail**, **Activities**, and **Accommodation** from a single, smooth interface.
* **Featured Products:** You now have the option to feature specific products to drive more sales.
* **Custom Organization:** Re-order items in your shop and create **Custom Activity Categories** to fit your center's unique offerings.
* **Streamlined Guest Checkout:** A faster, modern process designed to reduce friction and abandoned carts.
...
* **Filter & Export:** The payments page now includes robust filters and a full export function.
