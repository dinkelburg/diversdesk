...
- To delete a trip, open that trip and use **Delete trip** in the planner flow. The planner asks for confirmation before removal and unschedules the affected participants.
